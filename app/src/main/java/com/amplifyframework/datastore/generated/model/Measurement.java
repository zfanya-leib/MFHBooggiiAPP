...
public final class Measurement implements Model {
  ...
  private Measurement(String id, String name, Double value, Temporal.Timestamp timestamp) {
    this.id = id;
    this.name = name;
    this.value = value;
  ...
  public static class Builder implements NameStep, ValueStep, TimestampStep, BuildStep {
    private String id;
    private String name;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, Double value, Temporal.Timestamp timestamp) {
      super.id(id);
      super.name(name)
        .value(value)
        .timestamp(timestamp);
